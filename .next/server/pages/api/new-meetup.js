...
const handler = async (req, res)=>{
    if (req.method === "POST") {
        const data = req.body;
        try {
            const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://ajquidasol615:AjaBoy615@cluster0.03hsvqo.mongodb.net/meetups?retryWrites=true&w=majority");
            const db = client.db();
